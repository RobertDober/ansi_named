defmodule ColorNamed.AnsiColorNames do
  ...
  defmacro __using__(_opts) do
    ...
    ansi_color_names = ansi_colors |> Enum.map(fn {name, _} -> name end)
    ...
    quote do
      ...
      """
      @spec ansi_color_names() :: list(binary())
      def ansi_color_names do
        unquote(ansi_color_names)
      end

      @doc false 
      @spec ansi_colors() :: map()
      def ansi_colors do
        unquote(ansi_colors) |> Enum.into(%{})
      end
    end
